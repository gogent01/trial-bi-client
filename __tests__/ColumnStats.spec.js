...
function getColumnMetadata(model, columnKey) {
...
describe('Checks for correct calculations of basic statistics', () => {
    ...
    it('should correctly find max and min date', () => {
        ...
        const max = (_a = result.data.find((item) => item.param === 'Максимум')) === null || _a === void 0 ? void 0 : _a.value;
        const min = (_b = result.data.find((item) => item.param === 'Минимум')) === null || _b === void 0 ? void 0 : _b.value;
