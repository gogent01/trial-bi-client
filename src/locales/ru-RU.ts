const messages = {
  meta: {
    title: 'Система аналитики данных клинических исследований',
    description:
      'BI-система для данных клинических испытаний, предоставляющая обширные возможности по обработке данных. Позволяет исследовать структуру данных и подготавливать их для дальнейшего анализа в статистическом программном обеспечении.',
  },
  buttons: {
    group: 'Группировать',
